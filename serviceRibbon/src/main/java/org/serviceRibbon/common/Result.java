package org.serviceRibbon.common;
...
public class  Result<T> {
    ...
    public static <T> Result<T> noResult() {
        return new Result<T>(ResultCode.QUERY_FAILED.getCode(), ResultCode.QUERY_FAILED.getMessage(), null);
    }
     ...
     * @param message 错误信息
     */
    public static <T> Result<T> noResult(String message) {
        return new Result<T>(ResultCode.FAILED.getCode(), message, null);
    }
     ...
     * @param message 错误信息
     */
    public static <T> Result<T> noResult(IErrorCode errorCode,String message) {
        return new Result<T>(errorCode.getCode(), message, null);
    }
