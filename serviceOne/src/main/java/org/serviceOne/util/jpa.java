...
public class jpa {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < numOfSheets; i++) {
            if (xssfWorkbook.getSheetAt(i).getSheetName().equals("ECT_CN_AFTER_REPORT")) {
                write(i);
            }
        }
    ...
    private static void writeController() throws IOException {
        ...
        data.append("package org.serviceOne.controller;\n" +
                "\n" +
                "import org.serviceOne.entity." + className + ";\n" +
                "import org.serviceOne.service.I" + className + "Service;\n" +
                "import org.springframework.beans.factory.annotation.Autowired;\n" +
                ...
                "    }\n" +
                "}");
        File file = new File("src\\main\\java\\org\\serviceOne\\controller\\" + className + "Controller.java");
        if (file.exists())
            file.delete();
    ...
    private static void writeRepository() throws IOException {
        data = new StringBuilder();
        data.append("package org.serviceOne.repository;\n" +
                "\n" +
                "import org.serviceOne.entity." + className + ";\n" +
                ...
                "}");
        File file = new File("src\\main\\java\\org\\serviceOne\\repository\\" + className + "Repository.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
    ...
    private static void writeMapper() throws IOException {
        ...
        data.append("package org.serviceOne.mapper;\n" +
                "\n" +
                "import org.serviceOne.entity." + className + ";\n" +
                ...
                "}");
        File file = new File("src\\main\\java\\org\\serviceOne\\mapper\\" + className + "Mapper.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
    ...
    private static void writeEntity() throws IOException {
        data = new StringBuilder();
        data.append("package org.serviceOne.entity;\n\n" +
                "import org.serviceOne.entity.base.BaseEntity;\n" +
                "import lombok.*;\n" +
...
//        System.out.println(data);
        ...
        File file = new File("src\\main\\java\\org\\serviceOne\\entity\\" + className + ".java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
...
//            reference = reference.replaceAll("\\\"|\\\'|\\\n","");
    ...
    private static void writeIService() throws IOException {
        ...
        data.append("package org.serviceOne.service;\n" +
                "\n" +
                "import org.serviceOne.entity." + className + ";\n" +
                "import org.serviceOne.service.base.IBaseService;\n" +
                "\n" +
                "public interface I" + className + "Service  extends IBaseService<" + className + ", String, Object> {\n" +
                "}");
        File file = new File("src\\main\\java\\org\\serviceOne\\service\\I" + className + "Service.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
    ...
    private static void writeServiceImpl() throws IOException {
        ...
        data.append("package org.serviceOne.service.impl;\n" +
                "\n" +
                "import org.serviceOne.entity." + className + ";\n" +
                "import org.serviceOne.mapper." + className + "Mapper;\n" +
                "import org.serviceOne.mapper.base.BaseMapper;\n" +
				...
				"\n" +
        		"}");
        File file = new File("src\\main\\java\\org\\serviceOne\\service\\impl\\" + className + "Service.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
