...
public class jpa {
    ...
    private static void writeController() throws IOException {
        ...
        data.append("package org.serviceTwo.controller;\n" +
                "\n" +
                "import org.serviceTwo.entity." + className + ";\n" +
                "import org.serviceTwo.service.I" + className + "Service;\n" +
                "import org.springframework.beans.factory.annotation.Autowired;\n" +
                ...
                "    }\n" +
                "}");
        File file = new File("src\\main\\java\\org\\serviceTwo\\controller\\" + className + "Controller.java");
        if (file.exists())
            file.delete();
    ...
    private static void writeRepository() throws IOException {
        data = new StringBuilder();
        data.append("package org.serviceTwo.repository;\n" +
                "\n" +
                "import org.serviceTwo.entity." + className + ";\n" +
                ...
                "}");
        File file = new File("src\\main\\java\\org\\serviceTwo\\repository\\" + className + "Repository.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
    ...
    private static void writeMapper() throws IOException {
        ...
        data.append("package org.serviceTwo.mapper;\n" +
                "\n" +
                "import org.serviceTwo.entity." + className + ";\n" +
                ...
                "}");
        File file = new File("src\\main\\java\\org\\serviceTwo\\mapper\\" + className + "Mapper.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
    ...
    private static void writeEntity() throws IOException {
        data = new StringBuilder();
        data.append("package org.serviceTwo.entity;\n\n" +
                "import org.serviceTwo.entity.base.BaseEntity;\n" +
                "import lombok.*;\n" +
...
//        System.out.println(data);
        ...
        File file = new File("src\\main\\java\\org\\serviceTwo\\entity\\" + className + ".java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
...
//            reference = reference.replaceAll("\\\"|\\\'|\\\n","");
    ...
    private static void writeIService() throws IOException {
        ...
        data.append("package org.serviceTwo.service;\n" +
                "\n" +
                "import org.serviceTwo.entity." + className + ";\n" +
                "import org.serviceTwo.service.base.IBaseService;\n" +
                "\n" +
                "public interface I" + className + "Service  extends IBaseService<" + className + ", String, Object> {\n" +
                "}");
        File file = new File("src\\main\\java\\org\\serviceTwo\\service\\I" + className + "Service.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
    ...
    private static void writeServiceImpl() throws IOException {
        ...
        data.append("package org.serviceTwo.service.impl;\n" +
                "\n" +
                "import org.serviceTwo.entity." + className + ";\n" +
                "import org.serviceTwo.mapper." + className + "Mapper;\n" +
                "import org.serviceTwo.mapper.base.BaseMapper;\n" +
				...
				"\n" +
        		"}");
        File file = new File("src\\main\\java\\org\\serviceTwo\\service\\impl\\" + className + "Service.java");
        if (file.exists())
            file.delete();
        boolean b = file.createNewFile();
        if (b) {
